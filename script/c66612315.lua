...
function c66612315.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return 
		Duel.IsExistingMatchingCard(c66612315.filter1,tp,LOCATION_DECK,0,2,nil) or
		Duel.IsExistingMatchingCard(c66612315.filter2,tp,LOCATION_EXTRA,0,1,nil)
	end
	local t={}
	local p=1
	...
	else sg=Duel.GetMatchingGroup(c66612315.filter2,tp,LOCATION_EXTRA,0,nil)
...
function c66612315.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	else sg=Duel.SelectMatchingCard(tp,c66612315.filter2,tp,LOCATION_EXTRA,0,1,1,nil) end
