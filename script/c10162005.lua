...
function c10162005.spfilter1(c,tp)
	return c:IsSetCard(0x9333) and c:IsAbleToDeckAsCost() and c:IsCanBeFusionMaterial()
		and Duel.IsExistingMatchingCard(c10162005.spfilter2,tp,LOCATION_MZONE,0,1,c,c:GetAttribute()) and c:IsFaceup()
end

function c10162005.spfilter2(c,att)
	return c:IsSetCard(0x9333) and c:IsAbleToDeckAsCost() and c:IsCanBeFusionMaterial() and c:IsFaceup() and c:GetAttribute()~=att 
end
