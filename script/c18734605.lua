...
function c18734605.filter1(c,e)
	return c:IsSetCard(0xab4) and c:IsAbleToGrave() and c:IsCanBeEffectTarget(e)
end
function c18734605.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.IsExistingMatchingCard(c18734605.filter1,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,1,nil,e)
	end
