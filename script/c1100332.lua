...
function c1100332.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then
		...
		return ft>-1 and Duel.IsExistingMatchingCard(c1100332.filter,tp,LOCATION_HAND+LOCATION_GRAVE+LOCATION_REMOVED,0,1,nil,e,tp,mg,ft)
	end
...
function c1100332.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	local tg=Duel.SelectMatchingCard(tp,c1100332.filter,tp,LOCATION_HAND+LOCATION_GRAVE+LOCATION_REMOVED,0,1,1,nil,e,tp,mg,ft)
