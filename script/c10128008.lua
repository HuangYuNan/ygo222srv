...
function c10128008.accost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.IsExistingMatchingCard(c10128008.costfilter,tp,LOCATION_GRAVE,0,1,c) and bit.band(c:GetType(),0x10002)==0x10002 and c:IsAbleToDeckAsCost() end
