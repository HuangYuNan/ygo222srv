...
function c75646028.ctfilter(c,tp)
	return c:IsReason(2) and c:IsPreviousLocation(14)
end
...
function c75646028.activate(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(3,tp,506)
	local g=Duel.SelectMatchingCard(tp,c75646028.filter,tp,1,0,1,1,nil)
...
function c75646028.repfilter(c,tp)
	return c:IsFaceup() and (c:GetAttack()==1750 and c:GetDefense()==1350 or not c:IsType(c:GetOriginalType())) and c:IsLocation(12)
