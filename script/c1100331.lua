...
function c1100331.initial_effect(c)
	...
	e1:SetCondition(c1100331.thcon)
	e1:SetTarget(c1100331.thtg)
	e1:SetOperation(c1100331.thop)
	c:RegisterEffect(e1)
	--attack up
	local e1=Effect.CreateEffect(c)
...
function c1100331.thcon(e,tp,eg,ep,ev,re,r,rp)
	return bit.band(e:GetHandler():GetSummonType(),SUMMON_TYPE_RITUAL)==SUMMON_TYPE_RITUAL
end
function c1100331.thfilter(c)
	return c:IsSetCard(0x5243) and c:IsAbleToHand()
end
function c1100331.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c1100331.thfilter,tp,LOCATION_DECK+LOCATION_GRAVE,0,1,nil) end
	Duel.SetOperationInfo(0,CATEGORY_TOHAND,nil,1,tp,LOCATION_DECK+LOCATION_GRAVE)
end
function c1100331.thop(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_ATOHAND)
	local g=Duel.SelectMatchingCard(tp,c1100331.thfilter,tp,LOCATION_DECK+LOCATION_GRAVE,0,1,1,nil)
