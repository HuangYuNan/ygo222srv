...
function c10140002.cost2(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.RemoveCounter(tp,1,0,0x1344,9,REASON_COST)
end
...
function c10140002.cost1(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.Hint(HINT_OPSELECTED,1-tp,e:GetDescription())
	Duel.RemoveCounter(tp,1,0,0x1344,6,REASON_COST)
end
...
function c10140002.ctfilter(c)
	return (c:IsSetCard(0x3333) or c:IsSetCard(0x5333)) and c:IsType(TYPE_MONSTER)
end
...
function c10140002.ctop(e,tp,eg,ep,ev,re,r,rp)
	 ...
	 c:AddCounter(0x1343+COUNTER_NEED_ENABLE,count)
	  end
end
