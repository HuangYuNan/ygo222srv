...
function c75646300.target(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.SetOperationInfo(0,0x08,nil,1,tp,0x21)
end
...
function c75646300.destg(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(Card.IsDestructable,tp,0,0x0c,1,nil) 
	and Duel.IsExistingMatchingCard(c75646300.rfilter,tp,0x0c,0,1,nil,e,tp) end
	Duel.Hint(3,tp,502)
	local g=Duel.SelectTarget(tp,Card.IsDestructable,tp,0,0x0c,1,1,nil)
...
function c75646300.desop(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc and tc:IsRelateToEffect(e) then
		...
		Duel.BreakEffect()
		Duel.Hint(3,tp,503)
		local g=Duel.SelectMatchingCard(tp,c75646300.rfilter,tp,0x0c,0,1,1,nil)
