...
function c66612325.initial_effect(c)
	...
	e3:SetCondition(c66612325.retcon)
	e3:SetTarget(c66612325.rettg)
	e3:SetOperation(c66612325.retop)
	c:RegisterEffect(e3)
	--sp
...
function c66612325.spfilter(c,e,tp)
	return c:IsSetCard(0x660) and not c:IsSetCard(0xe660)  and c:IsType(TYPE_MONSTER) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
