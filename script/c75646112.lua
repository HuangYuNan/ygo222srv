...
function c75646112.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c75646112.filter,tp,0x1,0,1,nil) end
	Duel.SetOperationInfo(0,0x8,nil,1,tp,0x1)
end
function c75646112.activate(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(3,tp,506)
	local g=Duel.SelectMatchingCard(tp,c75646112.filter,tp,0x1,0,1,1,nil)
...
function c75646112.cost(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	Duel.Remove(e:GetHandler(),5,0x80)
end
