...
function c75646313.spfilter(c,tp)
	return c:IsPreviousPosition(0x5) and c:IsPreviousLocation(0x0c)
...
function c75646313.filter(c)
	return (c:IsSetCard(0x32c3) or c:IsSetCard(0x52c3)) and c:IsAbleToDeck()
end
