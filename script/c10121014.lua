...
function c10121014.cgfilter(c)
	return (c:IsFacedown() and c:IsOnField()) or (c:IsLocation(LOCATION_HAND) and not c:IsPublic())
end
...
function c10121014.spop(e,tp,eg,ep,ev,re,r,rp,c)
	...
	local cg=g:Filter(c10121014.cgfilter,nil)
