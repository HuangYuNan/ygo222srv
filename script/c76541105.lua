...
function c76541105.regfilter(c,i)
	return c:IsPreviousLocation(LOCATION_EXTRA) and c:GetSummonPlayer()==i
end
...
function c76541105.check_function(c,e,tp)
...
function c76541105.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk~=0 then return end
	local c=e:GetHandler()
	local valid_choice=c76541105.check_function(c,e,tp)
	return c76541105.valid_choice_count(valid_choice)>=2
end
...
function c76541105.splimitcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.GetFlagEffect(1-tp,76541105)~=0
end
