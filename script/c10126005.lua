...
function c10126005.spcon(e,c)
	...
	return Duel.GetLocationCount(tp,LOCATION_MZONE)>-1
		and Duel.IsExistingMatchingCard(c10126005.spfilter1,tp,LOCATION_MZONE,0,1,nil)
end
function c10126005.spfilter1(c)
	local eg=c:GetEquipGroup()
	return eg:GetCount()>=2 and eg:IsExists(Card.IsSetCard,1,nil,0x1335)
end
