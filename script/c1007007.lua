...
function c1007007.thtg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return sc:IsDestructable()
		and Duel.IsExistingMatchingCard(c1007007.thfilter,tp,LOCATION_DECK,0,1,nil) end
...
function c1007007.deop(e,tp,eg,ep,ev,re,r,rp)
	...
	local tc=Duel.SelectMatchingCard(tp,c1007007.filter,tp,LOCATION_DECK,0,1,1,nil,tp):GetFirst()
