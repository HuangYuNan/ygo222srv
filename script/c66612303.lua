...
function c66612303.op(e,tp,eg,ep,ev,re,r,rp)
	if Duel.IsExistingMatchingCard(c66612303.gvfilter,tp,LOCATION_GRAVE,0,1,nil) 
    and    Duel.IsPlayerCanDraw(tp,1) 
    and	Duel.SelectYesNo(tp,aux.Stringid(66612303,3)) then 
	Duel.Hint(HINT_CARD,0,66612303)
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_REMOVE)
	local g=Duel.SelectMatchingCard(tp,c66612303.gvfilter,tp,LOCATION_GRAVE,0,1,1,nil)
