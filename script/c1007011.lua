...
function c1007011.initial_effect(c)
	...
	e4:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0x245))
	e4:SetValue(300)
	c:RegisterEffect(e4)
end
...
function c1007011.cffilter(c)
	return c:IsSetCard(0x245) and c:IsType(TYPE_MONSTER) and c:GetCode()~=1007011 and not c:IsPublic()
end
...
function c1007011.cffilter1(c)
	return c:IsSetCard(0x245) and c:IsType(TYPE_MONSTER) and not c:IsPublic()
end
