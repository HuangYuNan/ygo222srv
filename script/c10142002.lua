...
function c10142002.spop(e,tp,eg,ep,ev,re,r,rp)
   ...
   if c:IsRelateToEffect(e) and Duel.SpecialSummon(c,0,tp,1-tp,false,false,POS_FACEUP)~=0 and g:GetCount()>0 and rg:GetCount()>=1 and Duel.SelectYesNo(tp,aux.Stringid(10142002,1)) then
	Duel.BreakEffect()
