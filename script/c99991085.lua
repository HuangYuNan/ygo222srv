...
function c99991085.initial_effect(c)
	...
	e1:SetCountLimit(1,99991085+EFFECT_COUNT_CODE_OATH)
	e1:SetCondition(c99991085.condition)
	...
	e3:SetCountLimit(1,99991085+EFFECT_COUNT_CODE_OATH)
	...
	e4:SetCountLimit(1,99991085+EFFECT_COUNT_CODE_OATH)
...
function c99991085.condition(e,tp,eg,ep,ev,re,r,rp)
...
function c99991085.lpcost(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_CARD,0,099991085)
...
function c99991085.tg2(e,tp,eg,ep,ev,re,r,rp,chk,chkc)
	...
	if chk==0 then return Duel.IsExistingTarget(Card.IsAbleToRemove,tp,LOCATION_ONFIELD,LOCATION_ONFIELD,1,e:GetHandler()) 
	and  Duel.IsExistingMatchingCard(Card.IsAbleToRemove,tp,LOCAITON_HAND,0,1,e:GetHandler()) end
...
function c99991085.op2(e,tp,eg,ep,ev,re,r,rp)
	...
	local g=Duel.GetMatchingGroup(Card.IsAbleToRemove,tp,LOCAITON_HAND,0,nil)
...
function c99991085.cost2(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	e1:SetTarget(c99991085.splimit)
