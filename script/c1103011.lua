...
function c1103011.initial_effect(c)
	...
	e4:SetDescription(aux.Stringid(1103011,1))
	e4:SetType(EFFECT_TYPE_QUICK_O)
	e4:SetCode(EVENT_FREE_CHAIN)
	e4:SetHintTiming(0,TIMING_ATTACK)
	e4:SetRange(LOCATION_GRAVE)
	e4:SetCountLimit(1,1103011)
	e4:SetCondition(c1103011.condition)
	e4:SetCost(c1103011.cost)
	e4:SetOperation(c1103011.operation)
	c:RegisterEffect(e4)
end
