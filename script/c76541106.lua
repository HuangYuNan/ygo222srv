...
function c76541106.check_function(c,e,tp)
...
function c76541106.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk~=0 then return end
	local c=e:GetHandler()
	local valid_choice=c76541106.check_function(c,e,tp)
	return c76541106.valid_choice_count(valid_choice)>=2
end
