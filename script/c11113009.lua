...
function c11113009.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	e1:SetCondition(c11113009.setcon)
	e1:SetOperation(c11113009.setop)
	Duel.RegisterEffect(e1,tp)
end
function c11113009.setcon(e,tp,eg,ep,ev,re,r,rp)
	return Duel.IsExistingMatchingCard(c11113009.filter,tp,LOCATION_DECK,0,1,nil)
end 
function c11113009.setop(e,tp,eg,ep,ev,re,r,rp)
    Duel.Hint(HINT_CARD,0,11113009)
