...
function c73203109.initial_effect(c)
	...
	e1:SetDescription(aux.Stringid(73203109,0))
	...
	e1:SetCountLimit(1)
	e1:SetCost(c73203109.cost)
	e1:SetTarget(c73203109.atktg)
	e1:SetOperation(c73203109.atkop)
	c:RegisterEffect(e1)
	--special summon
	local e2=Effect.CreateEffect(c)
	e2:SetDescription(aux.Stringid(73203109,2))
	e2:SetCategory(CATEGORY_SPECIAL_SUMMON)
	e2:SetType(EFFECT_TYPE_SINGLE+EFFECT_TYPE_TRIGGER_O)
	e2:SetProperty(EFFECT_FLAG_DELAY)
	e2:SetCode(EVENT_TO_GRAVE)
	e2:SetCondition(c73203109.spcon)
	e2:SetTarget(c73203109.sptg)
	e2:SetOperation(c73203109.spop)
	c:RegisterEffect(e2)
	local e3=e2:Clone()
...
function c73203109.atkop(e,tp,eg,ep,ev,re,r,rp)
