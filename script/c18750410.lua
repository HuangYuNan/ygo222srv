...
function c18750410.initial_effect(c)
	...
	e1:SetCountLimit(1,18750410)
	e1:SetTarget(c18750410.target)
	e1:SetOperation(c18750410.operation)
	c:RegisterEffect(e1)
	--LV down
	...
	e2:SetCondition(c18750410.condition2)
	e2:SetOperation(c18750410.operation2)
	c:RegisterEffect(e2)
	--SPECIAL_SUMMON
	...
	e3:SetCondition(c18750410.condition3)
	e3:SetTarget(c18750410.target3)
	e3:SetOperation(c18750410.operation3)
	c:RegisterEffect(e3)
	...
	e4:SetTarget(c18750410.target3)
	e4:SetOperation(c18750410.operation3)
	c:RegisterEffect(e4)
end
function c18750410.desfilter(c)
...
function c18750410.condition2(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	return not c:IsLocation(LOCATION_DECK)
end
function c18750410.operation2(e,tp,eg,ep,ev,re,r,rp)
	local c=e:GetHandler()
	if not e:GetHandler():IsRelateToEffect(e) then return end
...
function c18750410.condition3(e,tp,eg,ep,ev,re,r,rp)
	return e:GetHandler():GetSummonType()==SUMMON_TYPE_PENDULUM
end
function c18750410.filter2(c)
