...
function c10123007.thfilter(c,eg,e,tp)
	return c:GetPreviousControler()==tp and c:IsControler(tp) and c:IsLocation(LOCATION_GRAVE)
		and bit.band(c:GetReason(),0x80008)==0x80008 and c:IsAbleToHand() and c:IsCanBeEffectTarget(e) and eg:IsExists(c10123007.thfilter2,1,nil,c)
end
function c10123007.thfilter2(c,mc)
	return c:GetSummonType()==SUMMON_TYPE_SYNCHRO and mc:GetReasonCard()==c
end
