...
function c37564024.target(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.GetLocationCount(tp,LOCATION_MZONE)>-1
		and Duel.IsExistingMatchingCard(c37564024.rsfilter,tp,LOCATION_DECK+LOCATION_HAND,0,2,nil,e,tp) end
...
function c37564024.operation(e,tp,eg,ep,ev,re,r,rp)
	...
	if not Duel.IsExistingMatchingCard(c37564024.rsfilter,tp,LOCATION_DECK+LOCATION_HAND,0,1,nil,e,tp) then return end
	Duel.Hint(HINT_SELECTMSG,tp,HINTMSG_SPSUMMON)
	local g=Duel.SelectMatchingCard(tp,c37564024.rsfilter,tp,LOCATION_DECK+LOCATION_HAND,0,2,2,nil,e,tp)
